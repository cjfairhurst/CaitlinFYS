...
public class AppManSearch_Page extends javax.swing.JPanel {
    ...
    private void smallsearch_buttonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_smallsearch_buttonMouseClicked
        radiobuttonSelected = employeeid_radiobutton.isSelected() || username_radiobutton.isSelected() || firstname_radiobutton.isSelected() || lastname_radiobutton.isSelected();
        ...
        if (radiobuttonSelected && !"".equals(searchFieldText)) {
            ...
            FYS.getQueryManager().createLog(TrackUser.getCurrentUser(), "AppManSearch_Page", "Searched for account " + searchFieldText + ".");
        } else {
    ...
    private void delete_buttonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_delete_buttonMouseClicked
        ...
        if (confirm == 0) {
            FYS.getQueryManager().createLog(TrackUser.getCurrentUser(), "AppManSearch_Page", "Deleted account " + selectedUsername + ".");
    ...
    private void save_buttonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_save_buttonMouseClicked
        ...
        if (employeeid_textfield.getText().equals("") || firstname_textfield.getText().equals("") || lastname_textfield.getText().equals("") || username_textfield.getText().equals("") || password_textfield.getText().equals("") || radiobuttonSelected == false) {
            editemptyfield_warning.setVisible(true);
            editemptyfield_warning.setEnabled(true);
        } else {
            FYS.getQueryManager().createLog(TrackUser.getCurrentUser(), "AppManSearch_Page", "Updated account " + username_field.getText() + ".");
            editAccount();
            FYS.getInstance().showPage(new AppManSearch_Page());
        }
