...
public class CaseData_Page extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        PDF_button = new javax.swing.JLabel();
        ...
        casedata_table = new javax.swing.JTable();
        ...
        PDF_button.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        PDF_button.setForeground(new java.awt.Color(255, 255, 255));
        PDF_button.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fys/Images/button_short.png"))); // NOI18N
        PDF_button.setText("Generate PDF");
        PDF_button.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        PDF_button.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                PDF_buttonMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                PDF_buttonMouseExited(evt);
            }
        });
        view_panel.add(PDF_button, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 480, -1, -1));
        ...
        view_panel.add(edit_button, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 480, -1, -1));
        ...
        casedata_button.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fys/Images/button_rollover_long.png"))); // NOI18N
        ...
        casedata_table.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        casedata_table.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                casedata_tableMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(casedata_table);
    ...
    private void casedata_tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_casedata_tableMouseClicked
        int row = casedata_table.getSelectedRow();
        selectedRow = (casedata_table.getModel().getValueAt(row, 0).toString());
        tableClicked = true;
    }//GEN-LAST:event_casedata_tableMouseClicked
    ...
    private void view_buttonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_view_buttonMouseClicked
        if (tableClicked) {
            ...
            edit_panel.setVisible(false);
            casedata_table.setVisible(false);
            casedata_table.setEnabled(false);
        } else {
    ...
    private void client_radiobuttonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_client_radiobuttonMouseClicked
        FYS.getInstance().updateTable(casedata_table, FYS.getQueryManager().fillTableCase("client"));
    ...
    private void baggage_radiobuttonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_baggage_radiobuttonMouseClicked
        FYS.getInstance().updateTable(casedata_table, FYS.getQueryManager().fillTableCase("baggage"));
        ...
        if (confirm == 0) {
            if (client_radiobutton.isSelected()) {
                if (FYS.getQueryManager().checkConnection(selectedRow)) {
                    ...
                    FYS.getQueryManager().createLog(TrackUser.getCurrentUser(), "CaseData_Page", "Deleted Client Case " + selectedRow + ".");
                ...
                if (FYS.getQueryManager().checkConnection(selectedRow)) {
                    ...
                    FYS.getQueryManager().createLog(TrackUser.getCurrentUser(), "CaseData_Page", "Deleted Baggage Case " + selectedRow + ".");
    ...
    private void save_buttonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_save_buttonMouseClicked
        ...
        if (client_radiobutton1.isSelected()) {
            if (emptyClientField) {
                ...
                try {
                    FYS.getQueryManager().createLog(TrackUser.getCurrentUser(), "CaseData_Page", "Updated Client Case " + firstname_field.getText() + " " + lastname_field.getText() + ".");
                    updateCase("client");
                } catch (SQLException ex) {
                    Logger.getLogger(CaseData_Page.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (emptyBaggageField || (!found_radiobutton.isSelected() && !lost_radiobutton.isSelected() && !resolved_radiobutton.isSelected())) {
                ...
                try {
                    FYS.getQueryManager().createLog(TrackUser.getCurrentUser(), "CaseData_Page", "Updated Baggage Case.");
                    updateCase("baggage");
                } catch (SQLException ex) {
                    Logger.getLogger(CaseData_Page.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    private void saveconnection_buttonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_saveconnection_buttonMouseClicked
        if (clientTableClicked && baggageTableClicked) {
            FYS.getQueryManager().createLog(TrackUser.getCurrentUser(), "CaseData_Page", "Added connection between Client Case " + selectedClientRow + " and Baggage Case " + selectedBaggageRow + ".");
    ...
    private void PDF_buttonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PDF_buttonMouseEntered
        ImageIcon II = new ImageIcon(getClass().getResource("Images/button_rollover_short.png"));
        PDF_button.setIcon(II);
    }//GEN-LAST:event_PDF_buttonMouseEntered

    private void PDF_buttonMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PDF_buttonMouseExited
        ImageIcon II = new ImageIcon(getClass().getResource("Images/button_short.png"));
        PDF_button.setIcon(II);
    }//GEN-LAST:event_PDF_buttonMouseExited
    ...
    private javax.swing.JTable casedata_table;
